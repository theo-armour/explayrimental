...
*/				
	...
	heartShape.moveTo( x - 60, y + 20);
	heartShape.bezierCurveTo( x - 60, y + 20, x - 40, y + 0, x + 10, y + 10 );
	heartShape.bezierCurveTo( x + 0, y + 30, x - 50, y + 50, x - 60, y + 80);
	// heartShape.moveTo( x - 60, y + 80);
	heartShape.bezierCurveTo( x - 60, y + 80, x + 40, y + 80, x + 0, y + 80);
	
	heartShape.moveTo( x + 60, y + 20);
	heartShape.bezierCurveTo( x + 60, y + 20, x + 70, y + 10, x + 75, y + 0 );
	heartShape.bezierCurveTo( x + 80, y + 10, x + 80, y + 40, x + 80, y + 80);

	//heartShape.moveTo( x - 20, y + 0);
	//heartShape.bezierCurveTo( x - 20, y + 0, x + 50, y + 50, x + 100, y + 100 );				
...
// POST PROCESSING
	...
	effectBlurX.uniforms[ 'deltaFW' ].value = new THREE.Vector2( blurAmountX, 0 );
	effectBlurY.uniforms[ 'deltaFW' ].value = new THREE.Vector2( 0, blurAmountY );
